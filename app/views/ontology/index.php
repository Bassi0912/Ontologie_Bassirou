        ...
        <div class="sidebar-header">
            <div class="sidebar-logo">
                <svg width="20" height="20" viewBox="0 0 34 34" fill="none">
                    <polygon points="17,1 31,9 31,25 17,33 3,25 3,9" stroke="#a78bfa" stroke-width="1.5" fill="none"/>
                    <circle cx="17" cy="11" r="2" fill="#a78bfa"/>
                    <circle cx="10" cy="22" r="1.5" fill="#c4b5fd"/>
                    <circle cx="24" cy="22" r="1.5" fill="#c4b5fd"/>
                    <line x1="17" y1="11" x2="10" y2="22" stroke="#a78bfa" stroke-width="1"/>
                    <line x1="17" y1="11" x2="24" y2="22" stroke="#a78bfa" stroke-width="1"/>
                </svg>
                <div>
