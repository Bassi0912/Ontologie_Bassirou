...
(function () {
    ...
    const COLOR_PALETTE = ['#a78bfa','#c4b5fd','#f472b6','#7c3aed','#f5a623','#818cf8','#e879f9','#fb923c','#34d399','#60a5fa'];
        '#a78bfa','#c4b5fd','#f5a623','#7c3aed','#ff6b6b',
        '#ddd6fe','#ede9fe','#feca57','#8b5cf6','#5f27cd'
    ];
    ...
    function drawRadial(data) {
        ...
        function getColor(node) {
            if (node.depth === 0) return 'var(--violet)';
            let n = node;
    ...
    function drawProgressive(data) {
        ...
        svg.append('defs').append('marker')
            ...
            .attr('orient', 'auto')
            .append('path').attr('d', 'M0,-5L10,0L0,5').attr('fill', 'var(--lilac)');
    ...
    function drawTree(data) {
        ...
        function update(source) {
            ...
            nodeEnter.append('circle')
                .attr('r', 7)
                .attr('fill', d => d._children ? 'var(--violet)' : (d.children ? 'var(--lilac)' : 'var(--surface2)'))
                .attr('stroke', d => d._children || d.children ? 'var(--violet)' : 'var(--border)')
                .attr('stroke-width', 2);
